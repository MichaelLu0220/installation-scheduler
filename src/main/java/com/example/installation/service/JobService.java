...
public class JobService {
  ...
  @PostConstruct public void init(){
    ...
    j1.setJobId("JOB-0001"); j1.setStatus("Planned"); j1.setPriority("High");
    j1.setCustomerName("工廠一"); j1.setCustomerPhone("0912-345-678");
    ...
    j2.setJobId("JOB-0002"); j2.setStatus("Assigned"); j2.setPriority("Normal");
    j2.setCustomerName("工廠二"); j2.setCustomerPhone("0988-000-000");
    ...
    j3.setJobId("JOB-0003"); j3.setStatus("Draft"); j3.setPriority("Low");
    j3.setCustomerName("工廠三"); j3.setCustomerPhone("0933-666-999");
